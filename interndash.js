...
${u.missed>0?`
<div class="card quest">
<h3>⚠ Catch-Up Alert</h3>
<p>You missed ${u.missed} class(es). Complete MCQ quiz to unlock Quiz Master badge.</p>
</div>`:''}
...
if(s==='chat'){
app.innerHTML=
title('Chat','Chat with mentor and admin.')+
chatUI(['Admin','Sahana','Dhanush RV']);
